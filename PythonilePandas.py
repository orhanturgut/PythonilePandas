...
dataframes = [df1, df2, df3, df4, df6, df7, df8, df9, df10, df11, df12, df13, df14, df15, df16, df17, df18]
...
for dataframe in dataframes:
  ...
  if dataframe.RSI<=60 and dataframe.MOM <0:
    ...
    dataframe.decision = "ElindeTut/Bekle"

data = {'Crytpocurrency':  ['BTC-USD', 'ETH-USD', 'BNB-USD', 'DOGE-USD',  'ADA-USD', 'LINK-USD', 'USDT-USD', 'XRP-USD', 'LTC-USD', 'BCH-USD', 'XLM-USD', 'XMR-USD', 'NEO-USD', 'DASH-USD', 'USDC-USD', 'MIOTA-USD', 'XTZ-USD' ],
        'Fiyat': [df1.price, df2.price, df3.price, df4.price,  df6.price, df7.price, df8.price, df9.price, df10.price, df11.price, df12.price, df13.price, df14.price, df15.price, df16.price, df17.price, df18.price],
        'RSI': [df1.RSI, df2.RSI, df3.RSI, df4.RSI, df6.RSI,df7.RSI, df8.RSI, df9.RSI, df10.RSI, df11.RSI, df12.RSI, df13.RSI, df14.RSI, df15.RSI, df16.RSI, df17.RSI, df18.RSI],
        'Momentum' : [df1.MOM, df2.MOM, df3.MOM, df4.MOM,  df6.MOM, df7.MOM, df8.MOM, df9.MOM, df10.MOM, df11.MOM, df12.MOM, df13.MOM, df14.MOM, df15.MOM, df16.MOM, df17.MOM, df18.MOM],
        'Sonuc' : [df1.decision, df2.decision, df3.decision, df4.decision,  df6.decision, df7.decision, df8.decision, df9.decision, df10.decision, df11.decision, df12.decision, df13.decision, df14.decision, df15.decision, df16.decision, df17.decision, df18.decision]
        }
dfinal = pd.DataFrame (data, columns = ['Crytpocurrency','Fiyat','RSI', 'Momentum', 'Sonuc'])
